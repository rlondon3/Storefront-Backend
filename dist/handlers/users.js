...
var users_route = function (app) {
    app.get('/users', authenticate_1.authToken, index);
    app.get('/users/:id', show);
    app.post('/users', create);
    app.put('/users/:id', authenticate_1.authUserId, update);
    app["delete"]('/users/:id', authenticate_1.authUserId, deletes);
