...
var store = new order_products_1.OrderStore();
...
var product = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productOrder, ordered, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productOrder = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.ProductOrdered(productOrder)];
            case 2:
                ordered = _a.sent();
                res.json(ordered);
                return [3 /*break*/, 4];
